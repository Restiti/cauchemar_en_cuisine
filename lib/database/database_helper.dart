  ...
  Future<Database> _initDatabase() async {
    ...
    return await openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        String createTablesScript = await rootBundle.loadString('assets/sql/create_tables.sql');
        ...
        String insertDataScript = await rootBundle.loadString('assets/sql/insert_data.sql');
